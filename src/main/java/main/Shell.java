...
class Shell {
    ...
    public Shell(FileDiskManagement fileDiskManagement, MemoryManagement memoryManagement, DeviceManager deviceManager) {
            ...
            case "kill":
                if (parts.length == 2) {
                    try {
                        ...
                        process_management.Scheduler.getInstance().killProcess(pid);
                    } catch (NumberFormatException e) {
