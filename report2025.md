...
```
x1:
M 10000#C 3000#MR 0 10000#C 3000#MW 100 9000#C 3000#MR 0 10000#C 3000#Q#
x2:
M 4096#D Printer 1 10000#Q#
X3:
M 4096#D Printer 1 10000#Q#
X4:
M 10240#D USB 3 10000#Q#
x5:
M 4096#W t4 2000#Q#
x6:
M 4096#R t4 2000#Q#
...
```
00:00 exec x1 0
00:07 exec x2 0 x4 0 x9 0
00:15 exec x3 0 x5 0 x7 0
00:20 exec x6 0 x8 0
00:30 exec x10 0 x11 0
```
...
```mermaid
gantt
    title Gantt Chart for x1 to x11
    dateFormat  HH:mm
    axisFormat  %H:%M
    ...
    M 10000: 00:00, 00:00
    C 3000: 00:00, 00:03
    MR 0 10000: 00:03, 00:03
    C 3000: 00:03, 00:06
    MW 100 9000: 00:06, 00:06
    C 3000: 00:06, 00:09
    MR 0 10000: 00:09, 00:09
    C 3000: 00:09, 00:12
    Q: 00:12, 00:12

    section x2
    M 4096: 00:07, 00:07
    D Printer 1 10000: 00:07, 00:17
    Q: 00:17, 00:17

    section x3
    M 4096: 00:15, 00:16
    D Printer 1 10000: 00:17, 00:27
    Q: 00:27, 00:27

    section x4
    M 10240: 00:07, 00:07
    D USB 3 10000: 00:07, 00:17
    Q: 00:17, 00:17

    section x5
    M 4096: 00:15, 00:15
    W t4 2000: 00:15, 00:17
    Q: 00:17, 00:17

    section x6
    M 4096: 00:20, 00:20
    R t4 2000: 00:20, 00:22
    Q: 00:22, 00:22

    section x7
    M 4096: 00:15, 00:16
    W t4 2000: 00:17, 00:19
    Q: 00:19, 00:19
...
![image-20250516160640093](./report2025.assets/image-20250516160640093.png)

x1读内存

![image-20250516160738784](./report2025.assets/image-20250516160738784.png)

x1写内存

![image-20250516160813689](./report2025.assets/image-20250516160813689.png)

`00:07 exec x2 0 x4 0 x9 0`，x2与x4占用外设，x9和x1并行占用CPU

![image-20250516161220161](./report2025.assets/image-20250516161220161.png)

x1读内存，x9释放资源

![image-20250516161325080](./report2025.assets/image-20250516161325080.png)

x1占用CPU结束，释放资源

![image-20250516161430060](./report2025.assets/image-20250516161430060.png)

`00:15 exec x3 0 x5 0 x7 0`，x3等待x2外设使用完毕，x5写文件，x7等待

![image-20250516161530138](./report2025.assets/image-20250516161530138.png)

x5写文件完毕，x7开始写，x2，x4外设使用完毕，轮到x3使用外设

![image-20250516161724501](./report2025.assets/image-20250516161724501.png)

x7写完，x6，x8并行读

![image-20250516162038077](./report2025.assets/image-20250516162038077.png)

最后x10，x11并行占用CPU

![image-20250516162119209](./report2025.assets/image-20250516162119209.png)

测试完毕

![image-20250516162150325](./report2025.assets/image-20250516162150325.png)
